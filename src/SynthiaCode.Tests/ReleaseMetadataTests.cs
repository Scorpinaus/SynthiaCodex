...
{
    private const string ExpectedReleaseVersion = "0.1.0";
    ...
    public void Architecture_snapshot_describes_the_current_release_boundary()
    {
        ...
        Assert.Contains("**Release:** 0.1.0", architecture, StringComparison.Ordinal);
    ...
    public void Readme_publishes_the_current_release_and_architecture_links()
    {
        ...
        Assert.Contains("**Current release:** 0.1.0", readme, StringComparison.Ordinal);
