...
public sealed record CodexExecutionPolicyRequirements
{
    ...
    public CodexExecutionPolicyRequirements(
        IReadOnlyList<CodexSandbox> allowedSandboxes,
        IReadOnlyList<CodexApprovalPolicy> allowedApprovalPolicies,
        IReadOnlyList<CodexApprovalsReviewer> allowedApprovalsReviewers,
        IReadOnlyList<string> allowedPermissionProfiles)
    {
        AllowedSandboxes = allowedSandboxes ?? [];
    ...
    public IReadOnlyList<CodexSandbox> AllowedSandboxes { get; }

    public IReadOnlyList<CodexApprovalPolicy> AllowedApprovalPolicies { get; }

    public IReadOnlyList<CodexApprovalsReviewer> AllowedApprovalsReviewers { get; }

    public IReadOnlyList<string> AllowedPermissionProfiles { get; }
